...
const { shuttleBookingSchema, idParamSchema, timetableQuerySchema, shuttleBookingGetAllFilter, shuttleBookingParkingSpaceUpdateSchema, shuttleBookingVehiclePickedUpSchema } = require('../validations/shuttleBooking.validation');
...
router
  ...
  .put(
    '/location',
    validateRequest({ bodySchema: shuttleBookingParkingSpaceUpdateSchema }),
    asyncHandler(async (req, res) => controller.setParkingSpaceLocation(req, res))
  )
